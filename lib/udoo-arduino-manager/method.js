...
Method.prototype.readAnalogRepeated = function (belzedoo, data, callback) {
    var obj = Object.assign({method: 'repeatedAnalogRead'}, data);
...
Method.prototype.notifyDigital = function (belzedoo, data, notifyCallback) {
    ...
    this.callbacks[data.id] = setInterval(()=>{
        this.readDigital(belzedoo, data, notifyCallback);
    }, data.interval);
};
...
Method.prototype.notifyAnalog = function (belzedoo, data, notifyCallback) {
    ...
    this.callbacks[data.id] = setInterval(()=>{
        this.readAnalog(belzedoo, data, notifyCallback);
    }, data.interval);
};
